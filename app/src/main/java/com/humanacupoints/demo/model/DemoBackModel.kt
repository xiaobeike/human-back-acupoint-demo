...
object DemoBackModel {
    ...
    val specs = listOf(
        ...
        AcupointSpec("bl13_l", "左肺俞", "足太阳膀胱经", "常用于呼吸系统相关理疗演示。", Side.LEFT, 0.16f, 0.36f),
        AcupointSpec("bl13_r", "右肺俞", "足太阳膀胱经", "常用于呼吸系统相关理疗演示。", Side.RIGHT, 0.16f, 0.36f),
        ...
        AcupointSpec("bl23_l", "左肾俞", "足太阳膀胱经", "靠近腰段，后续机器人阶段需叠加安全限力。", Side.LEFT, 0.84f, 0.26f),
        AcupointSpec("bl23_r", "右肾俞", "足太阳膀胱经", "靠近腰段，后续机器人阶段需叠加安全限力。", Side.RIGHT, 0.84f, 0.26f),
        AcupointSpec("du4", "命门", "督脉", "腰段中线参考点，可用于后续机器人重点区域演示。", Side.CENTER, 0.86f, 0f),
